...
| 主角剧情：开局 | https://tpr.inkit.cc/tpr5:主角剧情#开局 | story_section | 主角 | partially_implemented | none | 52_yanziwu, 杭州城 hook, 开封 hook, TBD | 5200.lua, jshyl_qqzj_quest.lua, opening event ids TBD | 侍剑/十二金钗 training TBD | 银子 implemented for arrival; other rewards TBD | qqzj_protagonist_opening_arrival_*; qqzj_protagonist_opening_*; qqzj_yanziwu_services_* | first subsection `qqzj_protagonist_opening_arrival` implemented; rest not implemented |
| 主角剧情：拜师 | https://tpr.inkit.cc/tpr5:主角剧情#拜师 | story_section | 主角 | extracted | 主角剧情：开局; family briefing/tool reward; 狼牙燕翎 | 52_yanziwu, future ShuiGe study marker | 5210.lua, 5211.lua, 5212.lua, jshyl_qqzj_quest.lua | 2周起 apprenticeship mentor test TBD | 狼牙燕翎 id 206 consumed; selected apprenticeship skill; 武学常识 +50; unchosen study skills | qqzj_protagonist_apprenticeship_* | extraction created in `docs/tpr_extraction/extractions/zhujuqinqing_apprenticeship.md`; not implemented |
