...
| 主角剧情：拜师 | https://tpr.inkit.cc/tpr5:主角剧情#拜师 | story_section | 主角 | extracted | docs/tpr_extraction/extractions/zhujuqinqing_apprenticeship.md; docs/tpr_extraction/TPR_042_APPRENTICESHIP_FIRST_SLICE_PLAN.md | TPR-041 extraction commit; TPR-042 first-slice planning commit | none | mentor choice and ShuiGe study specs extracted; first implementation slice planned as dedicated 5210 apprenticeship intro dialogue/flags only; no gameplay implemented |
