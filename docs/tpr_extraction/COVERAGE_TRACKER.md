...
| Page sections partially implemented | 1 | first subsection `qqzj_protagonist_opening_arrival` only |
...
| 主角剧情：开局 | https://tpr.inkit.cc/tpr5:主角剧情#开局 | story_section | 主角 | partially_implemented | docs/tpr_extraction/extractions/zhujuqinqing_opening.md | Phase 3C implementation commit | none | first subsection `qqzj_protagonist_opening_arrival` only |
