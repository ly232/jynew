...
| Page sections partially implemented | 1 | `qqzj_protagonist_opening_arrival`, `qqzj_protagonist_opening_qiudi_guard`, and `qqzj_protagonist_opening_family_briefing` only |
...
| 主角剧情：开局 | https://tpr.inkit.cc/tpr5:主角剧情#开局 | story_section | 主角 | partially_implemented | docs/tpr_extraction/extractions/zhujuqinqing_opening.md | Phase 3C, TPR-006, TPR-008, TPR-009A implementation commits | none | implemented subsections: arrival, 秋荻托付/孟星魂 assignment flag, verified 九转熊蛇丸 reward, 二叔/三叔 narrative hooks for 杭州/开封 |
