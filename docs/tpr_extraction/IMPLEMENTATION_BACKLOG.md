...
| TPR-031 | 主角剧情：开局 / first ShuiGe center chest reward | https://tpr.inkit.cc/tpr5:主角剧情#开局 | implementation | planned | TPR-030; qqzj_protagonist_opening_shuige_inner_completed | 52_yanziwu / proposed `jshyl_shuige_center_chest` | 5207.lua, jshyl_qqzj_quest.lua | none | 海月清辉 id 209 x1 only | qqzj_protagonist_opening_shuige_center_chest_started; qqzj_protagonist_opening_shuige_center_chest_reward_claimed; qqzj_protagonist_opening_shuige_center_chest_completed | add one scene trigger and one idempotent chest quest; no silver deduction, no other rewards |
