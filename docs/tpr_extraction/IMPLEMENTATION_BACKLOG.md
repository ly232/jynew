...
| TPR-009 | 主角剧情：开局 / 二叔三叔 briefing hooks | https://tpr.inkit.cc/tpr5:主角剧情#开局 | planning | implemented | TPR-008 | 52_yanziwu now; 杭州/开封 maps missing | reuse 5200.lua + jshyl_qqzj_quest.lua for TPR-009A; future 5206/5207 if NPCs added | none | defer 狼牙燕翎/秦皇照骨镜/洛阳铲 until item ids verified | qqzj_protagonist_opening_family_briefing_* | planning doc created; next safe slice is dialogue/flags-only hooks, no real maps |
