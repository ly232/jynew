...
| TPR-030 | 主角剧情：开局 / ShuiGe chest reward binding plan | https://tpr.inkit.cc/tpr5:主角剧情#开局 | planning | planned | TPR-029 | 52_yanziwu / ShuiGe markers | event ids TBD | none | real chest reward groups after item ids exist | proposed ShuiGe chest reward flags TBD | should plan the first small source-faithful ShuiGe chest payout slice; companion joins remain deferred |
