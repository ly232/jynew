...
| TPR-006 | 主角剧情：开局 / 秋荻托付 | https://tpr.inkit.cc/tpr5:主角剧情#开局 | planning | ready | TPR-005 arrival completed | 52_yanziwu | 5200.lua, jshyl_qqzj_quest.lua | none | defer 司南针/九转熊蛇丸 until item ids verified | qqzj_protagonist_opening_qiudi_guard_* | next recommended small slice: dialogue + 孟星魂 assigned flag, no companion Join yet |
