...
| TPR-028 | 主角剧情：开局 / remaining item-config strategy | https://tpr.inkit.cc/tpr5:主角剧情#开局 | planning | planned | TPR-027 | n/a | n/a | none | decide exact new rows vs approved placeholders for missing medicines, tools, and ShuiGe treasures | n/a | next recommended task; should not modify gameplay |
| TPR-029 | 主角剧情：开局 / minimal exact item config rows | https://tpr.inkit.cc/tpr5:主角剧情#开局 | implementation | planned | TPR-028 | n/a | config/generated Lua targets TBD by TPR-028 | none | first task that should introduce new items, limited to approved missing opening/ShuiGe rewards | n/a | do not implement chest payouts in the same slice |
