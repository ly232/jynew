...
| TPR-029 | 主角剧情：开局 / minimal exact item config rows | https://tpr.inkit.cc/tpr5:主角剧情#开局 | implementation | planned | TPR-028 | n/a | 物品.xlsx, generated ItemConfig.lua | none | introduce exact inert rows for 司南针, 狼牙燕翎, 秦皇照骨镜, 洛阳铲, 海月清辉 | n/a | first task that should introduce new items; do not implement chest payouts or reward grants in the same slice |
